...
--- Returns a [TiledCustomProperties](https://docs.hubos.dev/server/lua-api/areas#tiledcustomproperties)
---@param area_id string
...
---@param texture_path? string
---@param animation_path? string
function Net.message_player(player_id, message, texture_path, animation_path) end
...
---@param texture_path? string
---@param animation_path? string
function Net.question_player(player_id, question, texture_path, animation_path) end
...
---@param texture_path? string
---@param animation_path? string
function Net.quiz_player(player_id, option_a, option_b, option_c, texture_path, animation_path) end
...
function Async.message_player(player_id, message, texture_path, animation_path) end
...
function Async.question_player(player_id, question, texture_path, animation_path) end
...
function Async.quiz_player(player_id, option_a, option_b, option_c, texture_path, animation_path) end
